...
export const GroceryProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  const desc = language === 'te' 
    ? (product.descriptionTe || 'à°¤à°¾à°œà°¾ à°¨à°¾à°£à±à°¯à°®à±ˆà°¨ à°—à±à°°à°¾à°®à±€à°£ à°•à°¿à°°à°¾à°£à°¾ à°¸à°°à±à°•à±à°²à±') 
  ...
  return (
    <div className="group bg-white rounded-3xl border border-slate-200/80 hover:border-slate-400 p-4 sm:p-5 transition-all duration-300 flex flex-col justify-between shadow-xs hover:shadow-lg">
      ...
      <div className="relative aspect-square w-full rounded-2xl overflow-hidden bg-slate-50 mb-4 flex items-center justify-center p-2">
        ...
        {product.isDeal ? (
          <div className="absolute top-2 left-2 bg-[#166534] text-white font-black text-[9px] sm:text-[10px] px-2.5 py-1 rounded-full uppercase tracking-wider shadow-sm flex items-center gap-1">
        ...
        <div className="absolute bottom-2 right-2">
          {isOutOfStock ? (
            ...
            <button
              ...
              className="w-9 h-9 rounded-full bg-white hover:bg-[#166534] text-slate-800 hover:text-white border border-slate-200 shadow-md flex items-center justify-center transition-all duration-200 transform active:scale-90 cursor-pointer"
              title="Add to cart"
            ...
            <div className="flex items-center bg-[#166534] text-white rounded-full shadow-md overflow-hidden border border-[#14532d]">
              <button
      ...
      <div className="space-y-2">
        <div className="flex items-start justify-between gap-2">
          <div className="flex-1">
            ...
            <h4 className="font-black text-xs sm:text-sm text-slate-900 uppercase tracking-wide leading-tight line-clamp-1 group-hover:text-[#166534] transition-colors">
              {name}
            </h4>
        ...
        <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-[10px] text-slate-400">
          ...
          <span className="text-emerald-700 font-bold">âš¡ 20 Min</span>
        </div>
      </div>
