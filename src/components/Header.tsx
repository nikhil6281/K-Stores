  ...
  return (
    <header className="sticky top-0 z-40 bg-[#166534] text-white shadow-md">
        ...
        <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-1 font-semibold text-white hover:text-amber-300 transition-colors cursor-pointer bg-emerald-900/60 px-2 py-0.5 rounded-md border border-emerald-700/60 text-[11px]"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3.5 flex items-center justify-between gap-4">
        ...
        {/* Actions (Search Mobile, User, Cart) */}
