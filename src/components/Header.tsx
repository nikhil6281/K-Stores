...
export const Header: React.FC = () => {
  ...
  return (
    <>
      <header className="sticky top-0 z-40 bg-[#9e1a22] text-white shadow-md border-b border-[#83181d]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            >
              ...
              <span className="bg-white text-[#9e1a22] font-black text-xs min-w-[20px] h-5 px-1 rounded-full flex items-center justify-center shadow-md">
                {cartItemsCount}
              </span>
            </button>
