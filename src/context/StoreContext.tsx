...
import { subscribeToLiveOrders, subscribeToUserCart, syncCartToCloud, pushOrderToCloud, updateOrderStatusInCloud } from '../services/firebaseSync';
...
export const StoreProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const refreshOrdersFromCloud = useCallback(async () => {
    const cloudData = await Promise.resolve({ orders: [] });
